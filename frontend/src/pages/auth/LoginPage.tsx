...
export const LoginPage = () => {
  ...
  const handleDemoLogin = (role: "employee" | "hr") => {
    loginAsDemo(role);
    toast.success(
      `Signed in as demo ${role === "hr" ? "HR Admin" : "Employee"}`,
    );
    navigate(role === "employee" ? "/employee" : "/hr", { replace: true });
  };

  return (
    <div className="flex min-h-screen items-center justify-center bg-linear-to-br from-slate-50 via-blue-50/30 to-slate-100 p-4">
      <div className="animate-fade-in w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-slate-500">
            Your employee onboarding platform
          </p>
        </div>
